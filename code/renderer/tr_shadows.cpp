...
void RB_DoShadowTessEnd( vec3_t lightPos )
{
	...
	/*if (glConfig.doStencilShadowsInOneDrawcall) //Fluffy TODO: This code snippet is from JA/OpenJK but hasn't been fully merged
	{
...
void RB_CaptureScreenImage(void)
{
	...
	//GL_Bind( tr.screenImage ); //Fluffy TODO: This line is from JA/OpenJK but "screenImage" hasn't been merged
