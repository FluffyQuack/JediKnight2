...
void RE_Font_DrawString(int ox, int oy, const char *psText, const float *rgba, const int iFontHandle, int iMaxPixelWidth, const float fScale = 1.0f, int widescreenAnchor = RENDER2D_ANCHOR_MIDDLE); //Fluffy (Widescreen2D)
